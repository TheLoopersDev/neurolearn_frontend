            ...
            >
                ...
                <div className="flex flex-col items-center mb-4">
                    <div className="bg-blue-600 rounded-full w-30 h-30 flex items-center justify-center mb-2">
                        <Image src='/assets/images/logo.png' alt="Logo" height={120} width={120} />
                    </div>
                    <div className="text-lg font-semibold text-black">Academix</div>
                    <div className="text-gray-500 text-sm mb-2">Share the certificate with friends</div>
                </div>
                {/* Input + Copy */}
                ...
                <div className="flex justify-between items-center mt-2">
                    <div className="flex flex-col items-center text-xs">
                        <Image src="/assets/icons/whatsapp.svg" alt="WhatsApp" width={18} height={18} className="bg-[#F7F8FA] rounded-full" />
                        <span className="text-black">WhatsApp</span>
                    </div>
                    <div className="flex flex-col items-center text-xs">
                        <Image src="/assets/icons/messenger.svg" alt="Messenger" width={20} height={20} />
                        <span className="text-black">Messenger</span>
                    </div>
                    <div className="flex flex-col items-center text-xs">
                        <Image src="/assets/icons/facebook.svg" alt="Facebook" width={10} height={10} />
