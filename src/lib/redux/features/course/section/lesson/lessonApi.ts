...
export const lessonApi = createApi({
    ...
    endpoints: (builder) => ({
        ...
        createLesson: builder.mutation<ApiResponse<Lesson>, { courseId: string; sectionId: string; data: Partial<Lesson> }>({
        ...
        updateLesson: builder.mutation<ApiResponse<Lesson>, { lessonId: string; data: Partial<Lesson> }>({
            query: ({ lessonId, data }) => ({
        ...
        reorderLesson: builder.mutation<ApiResponse<null>, { sectionId: string; orderUpdates: { id: string; order: number }[] }>({
