        ...
        <div className="container mx-auto px-4 flex justify-between items-center">
          <div className="flex items-center">
            ...
            <nav className="hidden md:flex ml-8">
              <Link href="/courses" className="mx-2 text-sm text-gray-700 hover:text-blue-600">
                Khóa học
              </Link>
              <Link href="/categories" className="mx-2 text-sm text-gray-700 hover:text-blue-600">
                Danh mục
              </Link>
              <Link href="/teachers" className="mx-2 text-sm text-gray-700 hover:text-blue-600">
                Giảng viên
              </Link>
            </nav>
          </div>
          <div className="flex items-center">
            ...
            <div className="flex gap-2">
              ...
              <BubbleButton onClick={() => showModal('register')}>Đăng kí</BubbleButton>
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0">
            ...
            <p className="text-gray-700 mb-6">
              From coding skills to business topics. Udemy helps expand your professional
              development.
            </p>
            <Link
              href="/courses"
      ...
      <main className="container mx-auto px-4 py-8">
            ...
            {[1, 2, 3].map(i => (
              <div key={i} className="bg-white p-6 rounded-lg shadow-md text-center">
                <div className="mb-4 relative w-32 h-32 mx-auto rounded-full overflow-hidden">
                  <Image src="/placeholder-course.jpg" alt="Expert" fill className="object-cover" />
                </div>
                ...
                <Link href="#" className="text-blue-500 flex items-center justify-center">
        ...
        <section className="mb-16">
          <div className="bg-gray-100 p-8 rounded-lg">
            ...
            <p className="text-gray-700 mb-6">
              Explore your strengths, preferences, and discover your growth path with this quick
              personality quiz.
            </p>
