...
const BusinessDetailsModal: React.FC<BusinessDetailsModalProps> = ({
  ...
  const modalContent = (
    <div className="fixed inset-0 bg-black/20 bg-opacity-20 flex items-center justify-center z-50 p-4 backdrop-brightness-95">
        ...
        <div className="p-6">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg">
              <img
                src={
                  business.createdBy?.user?.avatar?.url || // ✅ thêm ?.
                  (typeof business.createdBy?.avatar === 'string'
                    ? business.createdBy?.avatar
                    : undefined) || // fallback nếu API trả avatar phẳng là string
                  (business.createdBy as any)?.avatar?.url || // fallback nếu avatar là object {url}
          ...
          {business.courses && business.courses.length > 0 && (
            <div className="mb-8">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">
                Courses ({business.courses.length})
              </h3>
